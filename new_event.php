...
<body>
			...
			<h3>Create a new event !</h3>
					<form id="form" enctype="multipart/form-data" method="POST" action="insert_event.php">
					...
					<tr>
						<td>Date:<input onclick="ds_sh(this);" name="date" readonly="readonly" style="cursor: text" />
						Time:<INPUT TYPE="text" NAME="time" value="" SIZE="30" MAXLENGTH="30"></td>
					</tr>
					<tr>
						<td>Persons in charge:</td>
					</tr>
					<tr>
						<td><INPUT TYPE="text" NAME="persons" value="" SIZE="90" MAXLENGTH="500"></td>
					</tr>
					<tr>
