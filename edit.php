...
<body>
			...
			<h3>Update your Event</h3>
					<form id="form" enctype="multipart/form-data" method="POST" action="update_event.php">
					<table class="table_blue" align="center" style="width:95%;">
					<tr>
						<td>Event name:</td>
					</tr>
					<tr>
						<td><INPUT TYPE="text" NAME="name" value="<?php echo $name; ?>" SIZE="30" MAXLENGTH="100"></td>
					</tr>
					<tr>
						<td>
						<label for="file">Picture: </label>
						<input type="file" name="file" id="file" /> 
						(No more than 2Mo. Types supported: gif, jpeg, pjpeg, png)
						</td>
					</tr>
					<tr>
						<td>Date:<input onclick="ds_sh(this);" name="date" value="<?php echo $date; ?>" readonly="readonly" style="cursor: text" />
						Time:<INPUT TYPE="text" NAME="time" value="<?php echo $time; ?>" SIZE="30" MAXLENGTH="30"></td>
					</tr>
					<tr>
						<td>Persons in charge:</td>
					</tr>
					<tr>
						<td><INPUT TYPE="text" NAME="persons" value="<?php echo $persons; ?>" SIZE="90" MAXLENGTH="500"></td>
					</tr>
					<tr>
						<td>Description of the event:</td>
					</tr>
					<tr>
						<td><center><textarea name="description" style="font-weight:70; color:black; resize:vertical;" cols="100" rows="10" > 
